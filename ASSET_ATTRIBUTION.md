...
The playable build includes short original WAV sound effects in `assets/sfx/`:
...
These files are generated by `tools/sfx/generate_sfx.py` using deterministic oscillator/noise envelopes. They do not use third-party samples, game audio, music, or style-prompted generated audio.
